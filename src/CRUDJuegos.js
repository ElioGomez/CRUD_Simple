...
class CRUDJuegos extends Component {
        ...
        <ul>
          {this.state.Juegos.map(juego => (
            <li key={juego.id} className={ juego.pasado ? 'pasado' : 'pendiente' }>
              {juego.titulo}
              <button onClick={this.onEliminarHandle.bind(this, juego.id)}>Eliminar</button>
              <button onClick={this.onEditarHandle.bind(this, juego.id, juego.titulo)}>Editar</button>
              <button onClick={this.onPasadoHandle.bind(this, juego.id)}>Pasado</button>
            </li>
          ))}
        </ul>
      </div>
